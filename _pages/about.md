...
- [$$O^2$$-Searcher: A Searching-based Agent Model for Open-Domain Open-Ended Question Answering](/publication/o2searcher)
...
- [Drive Like a Human: Rethinking Autonomous Driving with Large Language Models](/publication/drive_like_a_human)

  **Daocheng Fu**, **Licheng Wen**, **Xin Li**, Min Dou, Pinlong Cai, Botian Shi, Yu Qiao 

- [Dilu: A knowledge-driven approach to autonomous driving with large language models](/publication/DiLu)

  **Licheng Wen**, **Daocheng Fu**, **Xin Li**, Xinyu Cai, Tao Ma, Pinlong Cai, Min Dou, Botian Shi, Liang He, Yu Qiao

- [LimSim: A long-term interactive multi-scenario traffic simulator](/publication/LimSim)

  **Licheng Wen**, **Daocheng Fu**, Song Mao, Pinlong Cai, Min Dou, Yikang Li, Yu Qiao

- [Limsim++: A closed-loop platform for deploying multimodal llms in autonomous driving](/publication/limsim_plus)
...
- [Incremental path planning: Reservation system in V2X environment](/publication/IPP)

  Daocheng Fu, Pinlong Cai, Yilun Lin, Song Mao, Licheng Wen, Yikang Li

- [Trafficgpt: Viewing, processing and interacting with traffic foundation models](/publication/trafficgpt)
